...
<div class="row">
            ...
            <div class="box-header">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  ?>
                    <input type="checkbox"  class="minimal" name="pekerjaan" value="<?php echo $data['id_pekerjaan']?>"><?php echo $data['pekerjaan']?></label>
                    <?php
                     } 
                     ?>
                </div>
      ...
      <?php
        ...
        if (isset($_POST['clear'])) {
          ...
          $pk = mysql_query("SELECT * from tb_pekerjaan where id_pekerjaan = '".$_POST['pekerjaan']."'");
        $p = mysql_fetch_assoc($pk);
        $sk = mysql_query("SELECT * from tb_sukucadang where id_sukucadang = '".$_POST['sukucadang']."'");
        $s = mysql_fetch_assoc($sk);

        $total = $p['biaya']+$s['harga'];
